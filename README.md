...
| 07 | Project | Interpreter for NIPA_iMBK | Conducted pre-research for technology applications |
| 09 | Project | Interpreter for NIPA_Myongji University | Facilitated remodeling discussions for K-LAP technology |
| 10 | Project | Interpreter for NIA_Korea-Inter America Digital Government Forum | Assisted bilingual discussions on digital governance |
| 11 | Project | Interpreter for CABEI_K-CAFTA Forum | Represented the Costa Rican Embassy |
| 11 | Project | Interpreter for NIPA_ESP(Arduino) Course | Supported ESP educational workshops |

## 🚩 2023

| Period | Category | Activity | Notes |
| :---: | :---: | ------ | :--: |
| 08- 12 | Project | Assistant & Interpreter at NIA_Good Consulting Group Co. | Business coordination and international client communication |
